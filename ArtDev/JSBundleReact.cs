...
namespace ArtDev
{
    public class JSBundleReact : WebPart
    {
        ...
        public string ReactRootElement
        {
            get;
            set;
        }
        ...
        protected override void CreateChildControls()
        {
            ...
            if (this.ReactRootElement != null && this.JSBundleFile != null)
            {
                ...
                string file = mode == "true" ? "http://localhost:300/public/" + this.JSBundleFile.Substring(this.JSBundleFile.LastIndexOf('/') + 1) : this.JSBundleFile;
