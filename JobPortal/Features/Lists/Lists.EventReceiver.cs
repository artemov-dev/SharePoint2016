    ...
    public class ListsEventReceiver : SPFeatureReceiver
    {
        ...
        public override void FeatureActivated(SPFeatureReceiverProperties properties)
        {
            ...
            feature.CreateList("ArtDevHeaderMenu").SetListTitle("ArtDev меню")
                ...
                .AddItemIfModeDevOrFirstDeploy("Home", "Header layout 1", "1", "index.html")
                .AddItemIfModeDevOrFirstDeploy("Home", "Header layout 2", "2", "index2.html")
                .AddItemIfModeDevOrFirstDeploy("Home", "Header layout 3", "3", "index3.html")
                .AddItemIfModeDevOrFirstDeploy("Home", "Header layout 4", "4", "index4.html")
                ;
