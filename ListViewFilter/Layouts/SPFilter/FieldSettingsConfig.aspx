                                                    ...
                                                    <table>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <select name="FieldType<%SPHttpUtility.NoEncode(index, Response.Output);%>" style="width:330px;">
                                                                    ...
                                                                    <% } %>
                                                                    <% if ((type & FilterType.Slider) == FilterType.Slider)
                                                                       {%>
                                                                    <option value="4096" <%= field.Type == FilterType.Slider ? @"selected=""selected""" : string.Empty %>>
                                                                        <%=LocalizedString("ControlType_Slider")%></option>
                                                                    <% } %>
                                                                    <% if ((type & FilterType.SliderRange) == FilterType.SliderRange)
                                                                       {%>
                                                                    <option value="8192" <%= field.Type == FilterType.SliderRange ? @"selected=""selected""" : string.Empty %>>
                                                                        <%=LocalizedString("ControlType_SliderRange")%></option>
                                                                    <% } %>
                                                                </select>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                if ((type & FilterType.Slider) == FilterType.Slider)
                                                                       {%><option value="4096"><%=LocalizedString("ControlType_Slider")%></option><% }
                                                                if ((type & FilterType.SliderRange) == FilterType.SliderRange)
                                                                       {%><option value="8192"><%=LocalizedString("ControlType_SliderRange")%></option><% } %>
                                                                </select>
                                                            </td>
                                                            <td>
                                                                <select onchange="Reorder(this, <%SPHttpUtility.NoEncode(index, Response.Output);%>, <%SPHttpUtility.NoEncode(CurrentListAllFieldsCount, Response.Output);%>)"
