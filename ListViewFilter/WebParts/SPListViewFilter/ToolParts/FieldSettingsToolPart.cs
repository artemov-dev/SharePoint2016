...
namespace ListViewFilter.WebParts.SPListViewFilter.ToolParts
{
    ...
    internal sealed class FieldSettingsToolPart : ToolPart
    {
        ...
        protected override void CreateChildControls()
        {
            ...
            if (WebPart.ListViewWebPart != null)
            {
                ...
                <script language=""javascript"">
                    function ShowSettingsModalDialog() {{
                        var url = '{0}/_layouts/SPFilter/FieldSettingsConfig.aspx?List={1}&Url={2}';
                ...
                Controls.Add(
                    new LiteralControl(
                        string.Format(
                            @"<a href=""#"" onclick=""javascript: ShowSettingsModalDialog(); return false;"">{0}</a>",
                            this.LocalizedString("Link_FieldSettings"))));
            }
            else
            {
                Controls.Add(new LiteralControl(this.LocalizedString("Error_WebPartNotConnected")));
            }
        }
